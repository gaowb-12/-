(function () {
  ...
  //区域地图 -地图数据
  var mapdata = [
    { name: '北京', miaoshu: '日均活跃用户', value: randomData() },
    { name: '天津', miaoshu: '日均活跃用户', value: randomData() },
    { name: '江西', miaoshu: '日均活跃用户', value: randomData() },
    { name: '广东', miaoshu: '日均活跃用户', value: 2100 }
  ...
  var zbbhqsOptions = {
    ...
    dataZoom: [{
      show: xdata.length>10?true:false, //控制下面滚动条
      height: 10,
      xAxisIndex: [
        0
      ],
